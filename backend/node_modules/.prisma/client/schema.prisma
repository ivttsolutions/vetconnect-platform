...
enum UserType {
  VET_PROFESSIONAL // Veterinario profesional colegiado
  VET_TECHNICIAN // Técnico/Auxiliar veterinario
  STUDENT // Estudiante de veterinaria
  PET_OWNER // Propietario de mascotas
  COMPANY // Empresa (requiere CompanyType)
  SHELTER // Refugio/Protectora de animales
  GENERAL // Usuario general interesado en el sector
}
...
model UserProfile {
  ...
  licenseNumber     String?  @unique // Número de colegiado
...
model CompanyProfile {
  ...
  coverPhoto  String?
  description String?
  companyType CompanyType // Tipo de empresa (obligatorio)
